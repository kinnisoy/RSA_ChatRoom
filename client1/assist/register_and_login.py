...
class LoginWindow(object):
    def __init__(self, Client, ADDR):
        self.top = Tk()
        self.top.title("登录注册界面")
        self.top.geometry("400x200")

        self.label = Label(self.top, text='Chat Room v1.1',height = 5)
        self.label.pack()
        ...
        self.input_password = Text( self.input2,height=1,width=15,
            font=('Helvetica', 12))
        # self.input_password = Entry(self.top,textvariable='password', show='*')
        ...
        self.register_button = Button(self.buttons, text='注册',
                                    command = self.register,
                                    fg='white', bg='blue')
        self.submit_button = Button(self.buttons, text='登录',
                                    command = self.submit,
                                    fg='white', bg='blue')
